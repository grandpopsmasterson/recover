import { GroupedProjects, GroupedProjectState, ShortProject } from "@/types/project";
...
const groupedProjectSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(getMultiQueryThunk.fulfilled, (state, action: PayloadAction<ShortProject[]>) => {
            state.loading = false;
            // Transform ShortProject[] to a single GroupedProjects entry
