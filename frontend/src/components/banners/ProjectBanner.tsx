...
// import AssignUserBtn from '@/components/buttons/AssignButton'
...
//     return (
//         <div 
//             className="grid grid-cols-4 grid-rows-3 gap-4 w-full py-4 pl-4 pr-8" 
//             style={{ height: '240px', gridTemplateRows: '2fr 1.5fr 2fr', backgroundColor: '#090f21' }}
//         >
...
//             <div className="!col-start-4 col-span-1 row-start-1 flex flex-col justify-center items-center gap-2">
//                 <button className="bg-purple-500 font-semibold w-3/4 h-12 text-xl px-2 rounded-xl hover:bg-purple-700 ease-in-out transition-all duration-200">
//                     Continue progress
//                 </button>
