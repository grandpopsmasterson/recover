...
const StepTwo = lazy(() => import('../../function/createProject/steps/StepTwo'));
const StepThree = lazy(() => import('../../function/createProject/steps/StepThree'));
const StepFour = lazy(() => import('../../function/createProject/steps/StepFour'));
const StepFive = lazy(() => import('../../function/createProject/steps/StepFive'));
